...
const roleViewRoute: RouteRecordRaw = {
	path: "role-view/:id",
	name: "ROLE_VIEW",
	props: true,
	component: () => import("@module/Role/pages/View.vue"),
	meta: {
		title: "view_role",
		activeLinkGroup: "ROLE_GROUP",
		contents: [],
...
export function RoleRoutes(sort: number): RouteRecordRaw[] {
	return [rolePageRoute, roleCreateRoute, roleViewRoute, roleUpdateRoute].map((route) => {
